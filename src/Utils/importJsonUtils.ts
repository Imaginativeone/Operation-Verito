      ...
      triggers: [
        {
          ...
          logic:
            "FOR EACH ROW WHEN NEW.last_modified < OLD.last_modified BEGIN UPDATE images SET last_modified= (strftime('%s', 'now')) WHERE id=OLD.id;END;",
        },
      ],
      values: [
        [1, 1, "Monday", 8.3, 10.0, 1, 0, 1618634218],
        [2, 2, "Wednesday", 14.0, 15.0, 2, 0, 1618634218],
        [3, 1, "Friday", 10.0, 12.0, 1, 0, 1618634218],
        [4, 10, "Tuesday", 8.3, 10.0, 10, 0, 1618634218],
        [5, 3, "Thursday", 14.0, 15.0, 12, 0, 1618634218],
        [6, 5, "Friday", 10.0, 12.0, 21, 0, 1618634218],
        [7, 5, "Monday", 8.3, 10.0, 11, 0, 1618634218],
        [8, 10, "Wednesday", 14.0, 15.0, 12, 0, 1618634218],
        [9, 3, "Friday", 10.0, 12.0, 15, 0, 1618634218],
        [10, 1, "Monday", 8.3, 10.0, 17, 0, 1618634218],
        [11, 2, "Wednesday", 14.0, 15.0, 32, 0, 1618634218],
        [12, 1, "Friday", 10.0, 12.0, 24, 0, 1618634218],
      ],
    },
  ],
};
