      ...
      if (platform === "ios" || platform === "android") {
        ...
        if (db === null)
          return Promise.reject(
            new Error(`CreateConnection ${cordDbList[0]} failed`),
          );
        ...
        const db1 = await sqlite.createConnection(
          cordDbList[1],
          false,
          "no-encryption",
          1,
        ...
        if (db1 === null)
          return Promise.reject(
            new Error(`CreateConnection ${cordDbList[1]} failed`),
          );
